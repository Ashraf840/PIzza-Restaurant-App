...
class OrderProgress(WebsocketConsumer):
    def connect(self):
        ...
        self.room_group_name = 'order_%s' % self.room_name  # the 'ws/pizza/<order_id>' apttern from the 'routing.py' file
        ...
        # Whenever the sockets get connected, it'll make a query to fetch the order-data using the staticmethod & json-dumps into the room_group.
    ...
    # Single channel-method; the data which is received by this channel will be extract/ fetched by the receiver-channel of this consumer, which then will be sent to the channel-group.
